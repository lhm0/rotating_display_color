...
<p align="center"> 
  <img src="/Users/ludwin/Elektronik/rotating_display_color/images/figure01.jpeg" style="display: inline-block; margin: 20px; max-width: 600px">
</p>
...
<p align="center"> 
  <img src="images/figure02.png" style="display: inline-block; margin: 20px; max-width: 600px">
</p>
...
The display board is equipped with a row containing 56 color LEDs. The LED operations are controlled by RP2040 microcontroller, while an ESP32 microcontroller generates the display content. The ESP32 maintains a Wi-Fi connection to the internet for this purpose.
